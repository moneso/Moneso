                  ...
                  return (
                    <div key={listing.id} className="border border-zinc-800 rounded-xl p-4 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <Link href={`/marketplace/${listing.id}`} className="text-xs text-zinc-400 hover:text-white px-3 py-1.5 border border-zinc-800 rounded-lg transition-colors">
                          View
                        </Link>
                        {listing.is_active && (
                          <button onClick={() => deleteListing(listing.id)} className="text-xs text-red-400 hover:text-red-300 px-3 py-1.5 border border-red-400/20 hover:border-red-400/40 rounded-lg transition-colors">
                            Delete
                          </button>
                        )}
                      </div>
