  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-1 text-white">P2P Marketplace</h1>
          <p className="text-sm text-zinc-400">Buy and sell Monero privately. No KYC. No intermediaries.</p>
          {currentPrice && (
